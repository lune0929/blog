...
| 대표 사용처 | 웹페이지                            | 일부 기업 시스템, 설정, 데이터 교환           | REST API(Representational State Transfer Application Programming Interface) 응답 | Docker Compose, </br>GitHub Actions, </br>Kubernetes |
